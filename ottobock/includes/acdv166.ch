		...
		#define STR0127 "Armazem associado a esta etiqueta esta diferente do item da separacao"
		#define STR0128 "Armazem associado a esta etiqueta esta diferente do item da separacao"
		#define STR0129 "Lote com saldo insuficiente"
		#define STR0130 "Saldo do lote insuficiente"
		#define STR0131 "Sera utilizado o lote original da liberacao do pedido"
#else
	#ifdef ENGLISH
